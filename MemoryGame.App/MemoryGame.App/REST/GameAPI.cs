...
namespace MemoryGame.App.REST
{
    ...
    {
        private const string APIUri = "https://ssprototype.com/wmgameleaderboard/api/game";
        HttpClient client;
        public GameAPI()
        {
            client = new HttpClient();
            client.DefaultRequestHeaders.Host = "ssprototype.com";//replace this value with your domain
